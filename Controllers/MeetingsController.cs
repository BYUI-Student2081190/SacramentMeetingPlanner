...
namespace SacramentMeetingPlanner.Controllers
{
    public class MeetingsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,WardName,Date")] Meeting meeting)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,WardName,Date")] Meeting meeting)
        {
            if (id != meeting.Id)
            {
                return NotFound();
